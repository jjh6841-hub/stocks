...
const CALENDAR = [
  ...
  // ── 사용자 보유 종목 실적 일정 ─────────────────────────────────────────
  // == 미국 ==
  { id:'us01', date:'2026-04-09', title:'델타 에어라인스 실적',      imp:'high', type:'earnings', desc:'DAL 1Q 실적',                     country:'US' },
  { id:'us02', date:'2026-04-15', title:'넷플릭스 실적',             imp:'high', type:'earnings', desc:'NFLX 1Q 실적',                    country:'US' },
  { id:'us03', date:'2026-04-15', title:'존슨앤드존슨 실적',         imp:'high', type:'earnings', desc:'JNJ 1Q 실적',                     country:'US' },
  { id:'us04', date:'2026-04-22', title:'보잉 실적',                 imp:'high', type:'earnings', desc:'BA 1Q 실적',                      country:'US' },
  { id:'us05', date:'2026-04-23', title:'알파벳(구글) 실적',         imp:'high', type:'earnings', desc:'GOOGL 1Q 실적',                   country:'US' },
  { id:'us06', date:'2026-04-23', title:'인튜이티브서지컬 실적',     imp:'high', type:'earnings', desc:'ISRG 1Q 실적',                    country:'US' },
  { id:'us07', date:'2026-04-23', title:'로크웰오토메이션 실적',     imp:'med',  type:'earnings', desc:'ROK 2Q 실적 (회계연도)',           country:'US' },
  { id:'us08', date:'2026-04-23', title:'서비스나우 실적',           imp:'high', type:'earnings', desc:'NOW 1Q 실적',                     country:'US' },
  { id:'us09', date:'2026-04-24', title:'인텔 실적',                 imp:'high', type:'earnings', desc:'INTC 1Q 실적',                    country:'US' },
  { id:'us10', date:'2026-04-24', title:'메타 실적',                 imp:'high', type:'earnings', desc:'META 1Q 실적',                    country:'US' },
  { id:'us11', date:'2026-04-28', title:'비자 실적',                 imp:'high', type:'earnings', desc:'V 2Q 실적 (회계연도)',             country:'US' },
  { id:'us12', date:'2026-04-28', title:'포드 실적',                 imp:'high', type:'earnings', desc:'F 1Q 실적',                       country:'US' },
  { id:'us13', date:'2026-04-29', title:'스타벅스 실적',             imp:'high', type:'earnings', desc:'SBUX 2Q 실적 (회계연도)',          country:'US' },
  { id:'us14', date:'2026-04-29', title:'일라이릴리 실적',           imp:'high', type:'earnings', desc:'LLY 1Q 실적',                     country:'US' },
  { id:'us15', date:'2026-04-29', title:'화이자 실적',               imp:'high', type:'earnings', desc:'PFE 1Q 실적',                     country:'US' },
  { id:'us16', date:'2026-04-29', title:'메리어트 인터내셔널 실적',  imp:'med',  type:'earnings', desc:'MAR 1Q 실적',                     country:'US' },
  { id:'us17', date:'2026-04-29', title:'로열캐리비언 실적',         imp:'med',  type:'earnings', desc:'RCL 1Q 실적',                     country:'US' },
  { id:'us18', date:'2026-05-01', title:'아마존 실적',               imp:'high', type:'earnings', desc:'AMZN 1Q 실적',                    country:'US' },
  { id:'us19', date:'2026-05-02', title:'엑슨모빌 실적',             imp:'high', type:'earnings', desc:'XOM 1Q 실적',                     country:'US' },
  { id:'us20', date:'2026-05-05', title:'팔란티어 실적',             imp:'high', type:'earnings', desc:'PLTR 1Q 실적',                    country:'US' },
  { id:'us21', date:'2026-05-06', title:'노르웨이지언크루즈 실적',   imp:'med',  type:'earnings', desc:'NCLH 1Q 실적',                    country:'US' },
  { id:'us22', date:'2026-05-07', title:'데이터도그 실적',           imp:'high', type:'earnings', desc:'DDOG 1Q 실적',                    country:'US' },
  { id:'us23', date:'2026-05-07', title:'모더나 실적',               imp:'high', type:'earnings', desc:'MRNA 1Q 실적',                    country:'US' },
  { id:'us24', date:'2026-05-28', title:'크라우드스트라이크 실적',   imp:'high', type:'earnings', desc:'CRWD 1Q 실적 (회계연도)',          country:'US' },
  { id:'us25', date:'2026-05-28', title:'줌 실적',                   imp:'med',  type:'earnings', desc:'ZM 1Q 실적 (회계연도)',            country:'US' },
  { id:'us26', date:'2026-05-28', title:'스노우플레이크 실적',       imp:'high', type:'earnings', desc:'SNOW 1Q 실적 (회계연도)',          country:'US' },
  { id:'us27', date:'2026-06-10', title:'심보틱 실적',               imp:'med',  type:'earnings', desc:'SYM 3Q 실적 (회계연도)',           country:'US' },
  { id:'us28', date:'2026-06-24', title:'카니발 실적',               imp:'med',  type:'earnings', desc:'CCL 2Q 실적 (회계연도)',           country:'US' },
  { id:'us29', date:'2026-06-25', title:'마이크론 실적',             imp:'high', type:'earnings', desc:'MU 3Q 실적 (회계연도)',            country:'US' },
  // == 한국 ==
  { id:'kr01', date:'2026-04-24', title:'현대차 실적',               imp:'high', type:'earnings', desc:'현대차 1Q 실적',                  country:'KR' },
  { id:'kr02', date:'2026-04-24', title:'기아 실적',                 imp:'high', type:'earnings', desc:'기아 1Q 실적',                    country:'KR' },
  { id:'kr03', date:'2026-04-24', title:'POSCO홀딩스 실적',          imp:'high', type:'earnings', desc:'POSCO홀딩스 1Q 실적',             country:'KR' },
  { id:'kr04', date:'2026-04-24', title:'LG에너지솔루션 실적',       imp:'high', type:'earnings', desc:'LG에너지솔루션 1Q 실적',          country:'KR' },
  { id:'kr05', date:'2026-04-24', title:'KT 실적',                   imp:'med',  type:'earnings', desc:'KT 1Q 실적',                      country:'KR' },
  { id:'kr06', date:'2026-04-25', title:'SK하이닉스 실적',           imp:'high', type:'earnings', desc:'SK하이닉스 1Q 실적',              country:'KR' },
  { id:'kr07', date:'2026-04-25', title:'NAVER 실적',                imp:'high', type:'earnings', desc:'NAVER 1Q 실적',                   country:'KR' },
  { id:'kr08', date:'2026-04-25', title:'LG전자 실적',               imp:'high', type:'earnings', desc:'LG전자 1Q 실적',                  country:'KR' },
  { id:'kr09', date:'2026-04-25', title:'SK텔레콤 실적',             imp:'med',  type:'earnings', desc:'SKT 1Q 실적',                     country:'KR' },
  { id:'kr10', date:'2026-04-25', title:'에스엠 실적',               imp:'med',  type:'earnings', desc:'SM Entertainment 1Q 실적',        country:'KR' },
  { id:'kr11', date:'2026-04-25', title:'기업은행 실적',             imp:'med',  type:'earnings', desc:'기업은행 1Q 실적',                country:'KR' },
  { id:'kr12', date:'2026-04-25', title:'삼성증권 실적',             imp:'med',  type:'earnings', desc:'삼성증권 1Q 실적',                country:'KR' },
  { id:'kr13', date:'2026-04-25', title:'현대해상 실적',             imp:'med',  type:'earnings', desc:'현대해상 1Q 실적',                country:'KR' },
  { id:'kr14', date:'2026-04-25', title:'신영증권 실적',             imp:'med',  type:'earnings', desc:'신영증권 1Q 실적',                country:'KR' },
  { id:'kr15', date:'2026-04-25', title:'LG유플러스 실적',           imp:'med',  type:'earnings', desc:'LG유플러스 1Q 실적',              country:'KR' },
  { id:'kr16', date:'2026-04-28', title:'삼성전자 잠정실적',         imp:'high', type:'earnings', desc:'삼성전자 1Q 잠정 실적',           country:'KR' },
  { id:'kr17', date:'2026-04-28', title:'삼성SDI 실적',              imp:'high', type:'earnings', desc:'삼성SDI 1Q 실적',                 country:'KR' },
  { id:'kr18', date:'2026-04-28', title:'한국항공우주 실적',         imp:'med',  type:'earnings', desc:'한국항공우주 1Q 실적',            country:'KR' },
  { id:'kr19', date:'2026-04-28', title:'현대모비스 실적',           imp:'high', type:'earnings', desc:'현대모비스 1Q 실적',              country:'KR' },
  { id:'kr20', date:'2026-04-28', title:'LG이노텍 실적',             imp:'med',  type:'earnings', desc:'LG이노텍 1Q 실적',                country:'KR' },
  { id:'kr21', date:'2026-04-28', title:'HD건설기계 실적',           imp:'med',  type:'earnings', desc:'HD건설기계 1Q 실적',              country:'KR' },
  { id:'kr22', date:'2026-04-28', title:'HS효성첨단소재 실적',       imp:'med',  type:'earnings', desc:'HS효성첨단소재 1Q 실적',          country:'KR' },
  { id:'kr23', date:'2026-04-28', title:'효성중공업 실적',           imp:'med',  type:'earnings', desc:'효성중공업 1Q 실적',              country:'KR' },
  { id:'kr24', date:'2026-04-28', title:'하이트진로 실적',           imp:'med',  type:'earnings', desc:'하이트진로 1Q 실적',              country:'KR' },
  { id:'kr25', date:'2026-04-28', title:'삼양식품 실적',             imp:'med',  type:'earnings', desc:'삼양식품 1Q 실적',                country:'KR' },
  { id:'kr26', date:'2026-04-28', title:'오리온 실적',               imp:'med',  type:'earnings', desc:'오리온 1Q 실적',                  country:'KR' },
  { id:'kr27', date:'2026-04-28', title:'넥슨게임즈 실적',           imp:'med',  type:'earnings', desc:'넥슨게임즈 1Q 실적',              country:'KR' },
  { id:'kr28', date:'2026-04-28', title:'엔씨소프트 실적',           imp:'high', type:'earnings', desc:'엔씨소프트 1Q 실적',              country:'KR' },
  { id:'kr29', date:'2026-04-28', title:'에코프로 실적',             imp:'high', type:'earnings', desc:'에코프로 1Q 실적',                country:'KR' },
  { id:'kr30', date:'2026-04-28', title:'에코프로비엠 실적',         imp:'high', type:'earnings', desc:'에코프로비엠 1Q 실적',            country:'KR' },
  { id:'kr31', date:'2026-04-28', title:'카카오뱅크 실적',           imp:'high', type:'earnings', desc:'카카오뱅크 1Q 실적',              country:'KR' },
  { id:'kr32', date:'2026-04-28', title:'카카오페이 실적',           imp:'med',  type:'earnings', desc:'카카오페이 1Q 실적',              country:'KR' },
  { id:'kr33', date:'2026-04-28', title:'카카오게임즈 실적',         imp:'med',  type:'earnings', desc:'카카오게임즈 1Q 실적',            country:'KR' },
  { id:'kr34', date:'2026-04-28', title:'이마트 실적',               imp:'med',  type:'earnings', desc:'이마트 1Q 실적',                  country:'KR' },
  { id:'kr35', date:'2026-04-29', title:'카카오 실적',               imp:'high', type:'earnings', desc:'카카오 1Q 실적',                  country:'KR' },
  { id:'kr36', date:'2026-04-29', title:'아모레퍼시픽 실적',         imp:'med',  type:'earnings', desc:'아모레퍼시픽 1Q 실적',            country:'KR' },
  { id:'kr37', date:'2026-04-29', title:'동양생명 실적',             imp:'med',  type:'earnings', desc:'동양생명 1Q 실적',                country:'KR' },
  { id:'kr38', date:'2026-04-29', title:'대한항공 실적',             imp:'med',  type:'earnings', desc:'대한항공 1Q 실적',                country:'KR' },
  { id:'kr39', date:'2026-04-29', title:'모두투어 실적',             imp:'med',  type:'earnings', desc:'모두투어 1Q 실적',                country:'KR' },
  { id:'kr40', date:'2026-04-29', title:'하나투어 실적',             imp:'med',  type:'earnings', desc:'하나투어 1Q 실적',                country:'KR' },
  { id:'kr41', date:'2026-04-29', title:'CJ프레시웨이 실적',         imp:'med',  type:'earnings', desc:'CJ프레시웨이 1Q 실적',            country:'KR' },
  { id:'kr42', date:'2026-04-29', title:'CJ제일제당 실적',           imp:'med',  type:'earnings', desc:'CJ제일제당 1Q 실적',              country:'KR' },
  { id:'kr43', date:'2026-04-29', title:'농심 실적',                 imp:'med',  type:'earnings', desc:'농심 1Q 실적',                    country:'KR' },
  { id:'kr44', date:'2026-04-29', title:'데브시스터즈 실적',         imp:'med',  type:'earnings', desc:'데브시스터즈 1Q 실적',            country:'KR' },
  { id:'kr45', date:'2026-04-29', title:'위메이드 실적',             imp:'med',  type:'earnings', desc:'위메이드 1Q 실적',                country:'KR' },
  { id:'kr46', date:'2026-04-29', title:'하이브 실적',               imp:'high', type:'earnings', desc:'하이브 1Q 실적',                  country:'KR' },
  { id:'kr47', date:'2026-04-29', title:'JYP Ent. 실적',            imp:'med',  type:'earnings', desc:'JYP Ent. 1Q 실적',                country:'KR' },
  { id:'kr48', date:'2026-04-29', title:'와이지엔터테인먼트 실적',   imp:'med',  type:'earnings', desc:'YG Entertainment 1Q 실적',        country:'KR' },
  { id:'kr49', date:'2026-04-29', title:'삼성E&A 실적',              imp:'med',  type:'earnings', desc:'삼성E&A 1Q 실적',                 country:'KR' },
  { id:'kr50', date:'2026-04-29', title:'이월드 실적',               imp:'med',  type:'earnings', desc:'이월드 1Q 실적',                  country:'KR' },
  { id:'kr51', date:'2026-04-29', title:'삼성전자우 실적',           imp:'med',  type:'earnings', desc:'삼성전자우 1Q 실적 (우선주)',     country:'KR' },
  { id:'kr52', date:'2026-05-14', title:'인텔리안테크 실적',         imp:'med',  type:'earnings', desc:'인텔리안테크 1Q 실적',            country:'KR' },
  { id:'kr53', date:'2026-05-14', title:'툴젠 실적',                 imp:'med',  type:'earnings', desc:'툴젠 1Q 실적',                    country:'KR' },
  { id:'kr54', date:'2026-05-14', title:'레인보우로보틱스 실적',     imp:'med',  type:'earnings', desc:'레인보우로보틱스 1Q 실적',        country:'KR' },
  { id:'kr55', date:'2026-05-14', title:'클로봇 실적',               imp:'med',  type:'earnings', desc:'클로봇 1Q 실적',                  country:'KR' },
  { id:'kr56', date:'2026-05-14', title:'유진로봇 실적',             imp:'med',  type:'earnings', desc:'유진로봇 1Q 실적',                country:'KR' },
  { id:'kr57', date:'2026-05-14', title:'이랜시스 실적',             imp:'med',  type:'earnings', desc:'이랜시스 1Q 실적',                country:'KR' },
];
...
const MarketOutlook: React.FC<{quotes:Record<string,Quote>;fg:{value:number;label:string};news:any[];loading:boolean}> = ({quotes,fg,news,loading}) => {
  ...
  const fgV = fg.value;
  const q = (yf:string) => quotes[yf];

  // 지수 ATH·52주 위치
  const spxQ   = q('^GSPC'), kospiQ = q('^KS11');
  const spxFromATH   = spxQ   ? (6147.43 - spxQ.price)  / 6147.43  * 100 : null;
  const kospiFromATH = kospiQ ? (3316.08 - kospiQ.price) / 3316.08  * 100 : null;
  const spx52Pos = spxQ && spxQ.high52w!==spxQ.low52w
    ? (spxQ.price - spxQ.low52w)/(spxQ.high52w - spxQ.low52w)*100 : null;

  // 섹터
  const secData   = SECTOR_DEF.map(s=>({...s, pct:q(s.yf)?.changePct??0, ok:!!q(s.yf)}));
  const secSorted = [...secData].filter(s=>s.ok).sort((a,b)=>b.pct-a.pct);

  // 안전자산
  const goldPct = q('GC=F')?.changePct ?? 0;
  const wtiPct  = q('CL=F')?.changePct ?? 0;

  // 뉴스
  const trumpNews = news.filter(n=>n.isTrump);
  const fedNews   = news.filter(n=>n.category==='macro');
  const negNews   = news.filter(n=>n.sentiment==='negative');

  // 캘린더 (향후 30일)
  const next30 = new Date(now); next30.setDate(next30.getDate()+30);
  const upcoming = CALENDAR
    .filter(e=>e.date>=today && e.date<=next30.toISOString().slice(0,10))
    .sort((a,b)=>a.date.localeCompare(b.date));
  const nextFomc     = upcoming.find(e=>e.type==='fed');
  const nextEcon     = upcoming.find(e=>e.type==='economic');
  const nextEarnings = upcoming.filter(e=>e.type==='earnings').slice(0,3);
  const nextOptions  = upcoming.find(e=>e.type==='options');

  // ── 강세/약세 신호 점수 ──────────────────────────────────────────────────
  let bull=0, bear=0;
  // FG: 극단 공포는 역발상 매수 신호지만 패닉 심화도 가능 → 점수 분리
  if(fgV<=20){bear+=2;bull+=1;}
  else if(fgV<=35) bear+=2;
  else if(fgV<=50) bull+=1;
  else if(fgV<=65) bull+=2;
  else { bull+=1; bear+=1; } // 탐욕: 단기 과열
  // ATH 대비 위치
  if(spxFromATH!==null){
    if(spxFromATH>20) bear+=2;
    else if(spxFromATH>10) bear+=1;
    else if(spxFromATH<5) bull+=1;
  }
  // 52주 위치
  if(spx52Pos!==null){
    if(spx52Pos<20) bear+=2;
    else if(spx52Pos>75) bull+=1;
  }
  // 안전자산 이동
  if(goldPct>1.5) bear+=1;
  if(wtiPct<-2) bear+=1;
  // 관세 뉴스
  if(trumpNews.length>=5) bear+=2;
  else if(trumpNews.length>=2) bear+=1;
  // 부정 뉴스 비율
  if(negNews.length/Math.max(news.length,1)>0.5) bear+=1;
  // 연준 기대
  if(fedNews.some(n=>/(cut|인하|pivot|완화)/.test((n.title||'').toLowerCase()))) bull+=1;
  if(fedNews.some(n=>/(hike|인상|hawkish|긴축)/.test((n.title||'').toLowerCase()))) bear+=1;
  // 섹터 온도
  if(secData.filter(s=>s.ok&&s.pct>1).length>=3) bull+=1;
  if(secData.filter(s=>s.ok&&s.pct<-1).length>=3) bear+=1;

  const total = bull+bear||1;
  const bullPct = Math.round(bull/total*100);
  const bearPct = 100-bullPct;
  type Scenario='bull'|'bear'|'base';
  const scenario:Scenario = bull>bear+1?'bull':bear>bull+1?'bear':'base';
  const scenarioLabel = scenario==='bull'?'강세 우세':scenario==='bear'?'약세 우세':'중립·관망';
  const scenarioColor = scenario==='bull'?'#00e676':scenario==='bear'?'#ff5252':'#ffd740';

  // ── 단기 전망 문장 추론 ──────────────────────────────────────────────────
  const shortLines:string[]=[];
  if(fgV<=25 && spxFromATH!==null && spxFromATH>15)
    shortLines.push(`공포 지수 ${fgV} — 과거 FG 20 이하 구간에서 S&P500은 3개월 내 평균 +12% 반등. 단, ${nextFomc?nextFomc.title:'연준 발표'}·관세 협상 등 촉매 없이는 기술적 반등에 그칠 수 있음. 2일 연속 양봉 확인 후 비중 확대 권장.`);
  else if(fgV<=35)
    shortLines.push(`공포 구간(${fgV})은 통상 저점 형성 시도 구간. 하지만 구조적 약세(관세 충격·실적 쇼크) 동반 시 추가 하락 가능 — ${nextEcon?nextEcon.title:'경제지표'} 발표 결과가 단기 방향 결정.`);
  else if(fgV>=70)
    shortLines.push(`탐욕 구간(${fgV}) — 단기 과매수 신호. 추가 상승 여지는 있으나 S&P500이 ATH 대비 ${spxFromATH!==null?`-${spxFromATH.toFixed(1)}%`:'근접'} 구간에서 차익실현 매물 증가 예상. 신규 진입보다 포지션 유지 권장.`);
  else
    shortLines.push(`공포탐욕 ${fgV}로 방향성 불명확. ${nextFomc?`${nextFomc.date.slice(5)} ${nextFomc.title}`:'FOMC'}·${nextEcon?nextEcon.title:'CPI'} 결과가 단기 분기점이 될 가능성. 이벤트 전까지 변동성 확대 구간.`);

  if(trumpNews.length>=3)
    shortLines.push(`트럼프 관세 뉴스 ${trumpNews.length}건 집중 — 한국 수출 비중이 높은 반도체(SK하이닉스·삼성전자)·방산(한화에어로·한국항공우주) 직접 영향. 관세 완화 시 즉각 반등, 추가 부과 시 KOSPI 추가 하락 가능.`);

  if(goldPct>1.5)
    shortLines.push(`금 +${goldPct.toFixed(1)}% — 글로벌 위험회피 심리 확인. 단기적으로 주식 대비 금·달러 선호 흐름이 지속될 가능성. 주식 비중 축소 후 금·방산 ETF(GLD·ITA)로 헤지 고려.`);

  // ── 중기 시나리오 ────────────────────────────────────────────────────────
  const bullCond = [
    nextFomc?`${nextFomc.title} 완화적 결과`:'연준 금리 인하 기대 확대',
    trumpNews.length>=2?'관세 협상 타결 또는 유예':'무역 불확실성 완화',
    '빅테크 실적 연속 서프라이즈',
  ].join(' + ');
  const bearCond = [
    trumpNews.length>=2?'관세 추가 확대·무역전쟁 장기화':'글로벌 경기 침체 신호',
    '연준 금리 인하 지연 또는 재인상',
    spxFromATH!==null&&spxFromATH>10?`S&P500 -${spxFromATH.toFixed(0)}% 구간 지지선 붕괴`:'CPI·고용 쇼크',
  ].join(' + ');

  // ── 핵심 변수 ────────────────────────────────────────────────────────────
  type KeyVar={event:string;impact:string;date?:string};
  const keyVars:KeyVar[]=[];
  if(nextFomc)     keyVars.push({event:nextFomc.title,     date:nextFomc.date,  impact:'금리 경로 재설정 → 성장주·채권·달러 전반에 영향. 인하 시사 시 강세, 매파적 발언 시 약세'});
  if(nextEcon)     keyVars.push({event:nextEcon.title,     date:nextEcon.date,  impact:'인플레·고용 상황 확인. 예상치 하회 시 연준 인하 기대 ↑, 상회 시 긴축 우려 재부각'});
  nextEarnings.forEach(e=>keyVars.push({event:e.title, date:e.date, impact:'실적 서프라이즈 여부 → 해당 섹터 방향성 결정. EPS 미스 시 섹터 전반 매물 출회'}));
  if(nextOptions)  keyVars.push({event:nextOptions.title,  date:nextOptions.date, impact:'만기 전후 변동성 확대, 헤지 포지션 정리로 방향성 급변 가능'});
  if(trumpNews.length>=2) keyVars.push({event:'관세 협상 진행 상황', impact:'한국 수출주·반도체·방산 직결. 트위터(X) 발언 하나에 장 중 급변동 가능'});

  // ── 추천 종목 ────────────────────────────────────────────────────────────
  type Rec={name:string;reason:string;horizon:string;color:string};
  const recs:Rec[]=[];
  if(scenario==='bull'||scenario==='base'){
    secSorted.slice(0,2).forEach(s=>{
      const sym=s.stocks[0];
      recs.push({name:STOCK_NAME[sym]||sym, horizon:'단기 1~2주', color:'#00e676',
        reason:`${s.name} 섹터 모멘텀(+${s.pct.toFixed(1)}%) 지속 시 동반 수혜 — 섹터 내 시총 1위 종목으로 수급 집중 효과`});
    });
  }
  if(fgV<=35 && kospiFromATH!==null && kospiFromATH>18)
    recs.push({name:'삼성전자', horizon:'중기 1~3개월', color:'#40c4ff',
      reason:`KOSPI ATH 대비 -${kospiFromATH.toFixed(0)}% — 역사적 저평가 구간. 반도체 업황 회복 사이클과 맞물릴 경우 중기 반등 가능`});
  if(goldPct>0.5||fgV<=35)
    recs.push({name:'금 (GC=F)', horizon:'단기~중기', color:'#ffd740',
      reason:`위험회피 심리 지속 + 달러 강세 시 안전자산 수요 증가. 포트폴리오 헤지 비중 10~20% 고려`});
  if(trumpNews.length>=3)
    recs.push({name:'한화에어로스페이스', horizon:'중기 1~3개월', color:'#ff9100',
      reason:'관세·지정학 리스크 고조 → 나토·한국 방산 예산 확대 기조 수혜. 관세 충격 상대적으로 낮은 내수 방산주'});
  if(nextEarnings.some(e=>e.title.includes('TSMC')))
    recs.push({name:'SK하이닉스', horizon:'단기 2~3주', color:'#40c4ff',
      reason:'TSMC 실적 발표 전후 HBM3E 수요 확인 기회. 서프라이즈 시 반도체 섹터 전반 상승 촉매'});

  if(loading) return <div style={{padding:'20px',textAlign:'center',color:'#8ea5b0'}}>분석 중...</div>;

  return (
    <div style={{padding:'4px 0'}}>
      <div style={{fontSize:'10px',color:'#607d8b',marginBottom:'14px'}}>
        🔄 {now.toLocaleTimeString('ko-KR',{hour:'2-digit',minute:'2-digit'})} 기준 자동 추론 · 투자 권유 아님
      </div>

      {/* 강세/약세 확률 바 */}
      <div style={{background:'#06111f',borderRadius:'8px',padding:'12px',marginBottom:'12px',border:`1px solid ${scenarioColor}44`}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'8px'}}>
          <span style={{fontSize:'13px',fontWeight:'700',color:scenarioColor}}>{scenarioLabel}</span>
          <span style={{fontSize:'11px',color:'#8ea5b0'}}>신호 강도 {Math.abs(bull-bear)}/{bull+bear}</span>
        </div>
        <div style={{display:'flex',height:'8px',borderRadius:'4px',overflow:'hidden',marginBottom:'6px'}}>
          <div style={{width:`${bullPct}%`,background:'#00e676'}}/>
          <div style={{width:`${bearPct}%`,background:'#ff5252'}}/>
        </div>
        <div style={{display:'flex',justifyContent:'space-between',fontSize:'11px'}}>
          <span style={{color:'#00e676'}}>강세 {bullPct}%</span>
          <span style={{color:'#ff5252'}}>약세 {bearPct}%</span>
        </div>
      </div>

      {/* 단기 전망 */}
      <div style={{marginBottom:'12px'}}>
        <div style={{fontSize:'11px',color:'#8ea5b0',letterSpacing:'1px',marginBottom:'6px'}}>📍 단기 전망 (1~2주)</div>
        {shortLines.map((line,i)=>(
          <div key={i} style={{fontSize:'12px',color:'#eceff1',lineHeight:'1.7',padding:'8px 10px',background:'#06111f',borderRadius:'6px',borderLeft:'2px solid #40c4ff',marginBottom:'6px'}}>
            {line}
          </div>
        ))}
      </div>
      ...
      {/* 중기 시나리오 */}
      <div style={{marginBottom:'12px'}}>
        <div style={{fontSize:'11px',color:'#8ea5b0',letterSpacing:'1px',marginBottom:'6px'}}>🔀 중기 시나리오 (1~3개월)</div>
        {[{label:'강세 시나리오',prob:bullPct,color:'#00e676',cond:bullCond,targets:secSorted.slice(0,2).map(s=>s.icon+s.name)},
          {label:'약세 시나리오',prob:bearPct,color:'#ff5252',cond:bearCond,targets:['🥇금','⛽브렌트유']}
        ].map((s,i)=>(
          <div key={i} style={{padding:'8px 10px',background:'#06111f',borderRadius:'6px',borderLeft:`2px solid ${s.color}`,marginBottom:'6px'}}>
            <div style={{display:'flex',justifyContent:'space-between',marginBottom:'4px'}}>
              <span style={{fontSize:'12px',fontWeight:'700',color:s.color}}>{s.label}</span>
              <span style={{fontSize:'12px',fontWeight:'700',color:s.color}}>{s.prob}%</span>
            </div>
            <div style={{fontSize:'11px',color:'#b0c4cc',lineHeight:'1.6',marginBottom:'4px'}}>조건: {s.cond}</div>
            <div style={{fontSize:'11px',color:'#8ea5b0'}}>주목: {s.targets.join(', ')}</div>
          </div>
        ))}
      </div>
      ...
      {keyVars.length>0&&(
        <div style={{marginBottom:'12px'}}>
          <div style={{fontSize:'11px',color:'#8ea5b0',letterSpacing:'1px',marginBottom:'6px'}}>🎯 방향을 결정할 핵심 변수</div>
          {keyVars.map((v,i)=>(
            <div key={i} style={{display:'flex',gap:'8px',padding:'7px 0',borderBottom:'1px solid #1a2535',alignItems:'flex-start'}}>
              <span style={{fontSize:'10px',color:'#607d8b',flexShrink:0,marginTop:'3px',minWidth:'32px'}}>{v.date?v.date.slice(5):''}</span>
              <div>
                <div style={{fontSize:'12px',color:'#eceff1',fontWeight:'600'}}>{v.event}</div>
                <div style={{fontSize:'11px',color:'#8ea5b0',marginTop:'2px',lineHeight:'1.5'}}>{v.impact}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      {recs.length>0&&(
        <div>
          <div style={{fontSize:'11px',color:'#8ea5b0',letterSpacing:'1px',marginBottom:'6px'}}>💡 전망 기반 주목 종목</div>
          {recs.map((r,i)=>(
            <div key={i} style={{padding:'7px 10px',background:'#06111f',borderRadius:'6px',marginBottom:'5px',borderLeft:`2px solid ${r.color}`}}>
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                <span style={{fontSize:'13px',color:'#eceff1',fontWeight:'600'}}>{r.name}</span>
                <span style={{fontSize:'10px',color:r.color,background:r.color+'22',padding:'2px 6px',borderRadius:'4px'}}>{r.horizon}</span>
              </div>
              <div style={{fontSize:'11px',color:'#b0c4cc',marginTop:'3px',lineHeight:'1.5'}}>{r.reason}</div>
            </div>
          ))}
        </div>
      )}
