...
const ECON_EVENTS = [
  ...
  // ── 사용자 보유 종목 실적 일정 ──────────────────────────────────────
  // == 미국 (기존 미등록 종목) ==
  { id:'us01', date:'2026-04-09', title:'델타 에어라인스 실적',    imp:'high', type:'earnings', desc:'DAL 1Q 실적' },
  { id:'us02', date:'2026-04-15', title:'존슨앤드존슨 실적',      imp:'high', type:'earnings', desc:'JNJ 1Q 실적' },
  { id:'us03', date:'2026-04-22', title:'보잉 실적',              imp:'high', type:'earnings', desc:'BA 1Q 실적' },
  { id:'us04', date:'2026-04-23', title:'인튜이티브서지컬 실적',  imp:'high', type:'earnings', desc:'ISRG 1Q 실적' },
  { id:'us05', date:'2026-04-23', title:'로크웰오토메이션 실적',  imp:'med',  type:'earnings', desc:'ROK 2Q 실적 (회계연도)' },
  { id:'us06', date:'2026-04-23', title:'서비스나우 실적',        imp:'high', type:'earnings', desc:'NOW 1Q 실적' },
  { id:'us07', date:'2026-04-24', title:'인텔 실적',              imp:'high', type:'earnings', desc:'INTC 1Q 실적' },
  { id:'us08', date:'2026-04-28', title:'비자 실적',              imp:'high', type:'earnings', desc:'V 2Q 실적 (회계연도)' },
  { id:'us09', date:'2026-04-28', title:'포드 실적',              imp:'high', type:'earnings', desc:'F 1Q 실적' },
  { id:'us10', date:'2026-04-29', title:'스타벅스 실적',          imp:'high', type:'earnings', desc:'SBUX 2Q 실적 (회계연도)' },
  { id:'us11', date:'2026-04-29', title:'일라이릴리 실적',        imp:'high', type:'earnings', desc:'LLY 1Q 실적' },
  { id:'us12', date:'2026-04-29', title:'화이자 실적',            imp:'high', type:'earnings', desc:'PFE 1Q 실적' },
  { id:'us13', date:'2026-04-29', title:'메리어트 인터내셔널 실적',imp:'med', type:'earnings', desc:'MAR 1Q 실적' },
  { id:'us14', date:'2026-04-29', title:'로열캐리비언 실적',      imp:'med',  type:'earnings', desc:'RCL 1Q 실적' },
  { id:'us15', date:'2026-05-02', title:'엑슨모빌 실적',          imp:'high', type:'earnings', desc:'XOM 1Q 실적' },
  { id:'us16', date:'2026-05-05', title:'팔란티어 실적',          imp:'high', type:'earnings', desc:'PLTR 1Q 실적' },
  { id:'us17', date:'2026-05-06', title:'노르웨이지언크루즈 실적',imp:'med',  type:'earnings', desc:'NCLH 1Q 실적' },
  { id:'us18', date:'2026-05-07', title:'데이터도그 실적',        imp:'high', type:'earnings', desc:'DDOG 1Q 실적' },
  { id:'us19', date:'2026-05-07', title:'모더나 실적',            imp:'high', type:'earnings', desc:'MRNA 1Q 실적' },
  { id:'us20', date:'2026-05-28', title:'크라우드스트라이크 실적',imp:'high', type:'earnings', desc:'CRWD 1Q 실적 (회계연도)' },
  { id:'us21', date:'2026-05-28', title:'줌 실적',                imp:'med',  type:'earnings', desc:'ZM 1Q 실적 (회계연도)' },
  { id:'us22', date:'2026-05-28', title:'스노우플레이크 실적',    imp:'high', type:'earnings', desc:'SNOW 1Q 실적 (회계연도)' },
  { id:'us23', date:'2026-06-10', title:'심보틱 실적',            imp:'med',  type:'earnings', desc:'SYM 3Q 실적 (회계연도)' },
  { id:'us24', date:'2026-06-24', title:'카니발 실적',            imp:'med',  type:'earnings', desc:'CCL 2Q 실적 (회계연도)' },
  { id:'us25', date:'2026-06-25', title:'마이크론 실적',          imp:'high', type:'earnings', desc:'MU 3Q 실적 (회계연도)' },
  // == 한국 ==
  { id:'kr01', date:'2026-04-24', title:'현대차 실적',            imp:'high', type:'earnings', desc:'현대차 1Q 실적' },
  { id:'kr02', date:'2026-04-24', title:'기아 실적',              imp:'high', type:'earnings', desc:'기아 1Q 실적' },
  { id:'kr03', date:'2026-04-24', title:'POSCO홀딩스 실적',       imp:'high', type:'earnings', desc:'POSCO홀딩스 1Q 실적' },
  { id:'kr04', date:'2026-04-24', title:'LG에너지솔루션 실적',    imp:'high', type:'earnings', desc:'LG에너지솔루션 1Q 실적' },
  { id:'kr05', date:'2026-04-24', title:'KT 실적',                imp:'med',  type:'earnings', desc:'KT 1Q 실적' },
  { id:'kr06', date:'2026-04-25', title:'SK하이닉스 실적',        imp:'high', type:'earnings', desc:'SK하이닉스 1Q 실적' },
  { id:'kr07', date:'2026-04-25', title:'NAVER 실적',             imp:'high', type:'earnings', desc:'NAVER 1Q 실적' },
  { id:'kr08', date:'2026-04-25', title:'LG전자 실적',            imp:'high', type:'earnings', desc:'LG전자 1Q 실적' },
  { id:'kr09', date:'2026-04-25', title:'SK텔레콤 실적',          imp:'med',  type:'earnings', desc:'SKT 1Q 실적' },
  { id:'kr10', date:'2026-04-25', title:'에스엠 실적',            imp:'med',  type:'earnings', desc:'SM Entertainment 1Q 실적' },
  { id:'kr11', date:'2026-04-25', title:'기업은행 실적',          imp:'med',  type:'earnings', desc:'기업은행 1Q 실적' },
  { id:'kr12', date:'2026-04-25', title:'삼성증권 실적',          imp:'med',  type:'earnings', desc:'삼성증권 1Q 실적' },
  { id:'kr13', date:'2026-04-25', title:'현대해상 실적',          imp:'med',  type:'earnings', desc:'현대해상 1Q 실적' },
  { id:'kr14', date:'2026-04-25', title:'신영증권 실적',          imp:'med',  type:'earnings', desc:'신영증권 1Q 실적' },
  { id:'kr15', date:'2026-04-25', title:'LG유플러스 실적',        imp:'med',  type:'earnings', desc:'LG유플러스 1Q 실적' },
  { id:'kr16', date:'2026-04-28', title:'삼성SDI 실적',           imp:'high', type:'earnings', desc:'삼성SDI 1Q 실적' },
  { id:'kr17', date:'2026-04-28', title:'한국항공우주 실적',      imp:'med',  type:'earnings', desc:'한국항공우주 1Q 실적' },
  { id:'kr18', date:'2026-04-28', title:'현대모비스 실적',        imp:'high', type:'earnings', desc:'현대모비스 1Q 실적' },
  { id:'kr19', date:'2026-04-28', title:'LG이노텍 실적',          imp:'med',  type:'earnings', desc:'LG이노텍 1Q 실적' },
  { id:'kr20', date:'2026-04-28', title:'HD건설기계 실적',        imp:'med',  type:'earnings', desc:'HD건설기계 1Q 실적' },
  { id:'kr21', date:'2026-04-28', title:'HS효성첨단소재 실적',    imp:'med',  type:'earnings', desc:'HS효성첨단소재 1Q 실적' },
  { id:'kr22', date:'2026-04-28', title:'효성중공업 실적',        imp:'med',  type:'earnings', desc:'효성중공업 1Q 실적' },
  { id:'kr23', date:'2026-04-28', title:'하이트진로 실적',        imp:'med',  type:'earnings', desc:'하이트진로 1Q 실적' },
  { id:'kr24', date:'2026-04-28', title:'삼양식품 실적',          imp:'med',  type:'earnings', desc:'삼양식품 1Q 실적' },
  { id:'kr25', date:'2026-04-28', title:'오리온 실적',            imp:'med',  type:'earnings', desc:'오리온 1Q 실적' },
  { id:'kr26', date:'2026-04-28', title:'넥슨게임즈 실적',        imp:'med',  type:'earnings', desc:'넥슨게임즈 1Q 실적' },
  { id:'kr27', date:'2026-04-28', title:'엔씨소프트 실적',        imp:'high', type:'earnings', desc:'엔씨소프트 1Q 실적' },
  { id:'kr28', date:'2026-04-28', title:'에코프로 실적',          imp:'high', type:'earnings', desc:'에코프로 1Q 실적' },
  { id:'kr29', date:'2026-04-28', title:'에코프로비엠 실적',      imp:'high', type:'earnings', desc:'에코프로비엠 1Q 실적' },
  { id:'kr30', date:'2026-04-28', title:'카카오뱅크 실적',        imp:'high', type:'earnings', desc:'카카오뱅크 1Q 실적' },
  { id:'kr31', date:'2026-04-28', title:'카카오페이 실적',        imp:'med',  type:'earnings', desc:'카카오페이 1Q 실적' },
  { id:'kr32', date:'2026-04-28', title:'카카오게임즈 실적',      imp:'med',  type:'earnings', desc:'카카오게임즈 1Q 실적' },
  { id:'kr33', date:'2026-04-28', title:'이마트 실적',            imp:'med',  type:'earnings', desc:'이마트 1Q 실적' },
  { id:'kr34', date:'2026-04-29', title:'카카오 실적',            imp:'high', type:'earnings', desc:'카카오 1Q 실적' },
  { id:'kr35', date:'2026-04-29', title:'아모레퍼시픽 실적',      imp:'med',  type:'earnings', desc:'아모레퍼시픽 1Q 실적' },
  { id:'kr36', date:'2026-04-29', title:'동양생명 실적',          imp:'med',  type:'earnings', desc:'동양생명 1Q 실적' },
  { id:'kr37', date:'2026-04-29', title:'대한항공 실적',          imp:'med',  type:'earnings', desc:'대한항공 1Q 실적' },
  { id:'kr38', date:'2026-04-29', title:'모두투어 실적',          imp:'med',  type:'earnings', desc:'모두투어 1Q 실적' },
  { id:'kr39', date:'2026-04-29', title:'하나투어 실적',          imp:'med',  type:'earnings', desc:'하나투어 1Q 실적' },
  { id:'kr40', date:'2026-04-29', title:'CJ프레시웨이 실적',      imp:'med',  type:'earnings', desc:'CJ프레시웨이 1Q 실적' },
  { id:'kr41', date:'2026-04-29', title:'CJ제일제당 실적',        imp:'med',  type:'earnings', desc:'CJ제일제당 1Q 실적' },
  { id:'kr42', date:'2026-04-29', title:'농심 실적',              imp:'med',  type:'earnings', desc:'농심 1Q 실적' },
  { id:'kr43', date:'2026-04-29', title:'데브시스터즈 실적',      imp:'med',  type:'earnings', desc:'데브시스터즈 1Q 실적' },
  { id:'kr44', date:'2026-04-29', title:'위메이드 실적',          imp:'med',  type:'earnings', desc:'위메이드 1Q 실적' },
  { id:'kr45', date:'2026-04-29', title:'하이브 실적',            imp:'high', type:'earnings', desc:'하이브 1Q 실적' },
  { id:'kr46', date:'2026-04-29', title:'JYP Ent. 실적',         imp:'med',  type:'earnings', desc:'JYP Ent. 1Q 실적' },
  { id:'kr47', date:'2026-04-29', title:'와이지엔터테인먼트 실적',imp:'med',  type:'earnings', desc:'YG Entertainment 1Q 실적' },
  { id:'kr48', date:'2026-04-29', title:'삼성E&A 실적',           imp:'med',  type:'earnings', desc:'삼성E&A 1Q 실적' },
  { id:'kr49', date:'2026-04-29', title:'이월드 실적',            imp:'med',  type:'earnings', desc:'이월드 1Q 실적' },
  { id:'kr50', date:'2026-04-29', title:'삼성전자우 실적',        imp:'med',  type:'earnings', desc:'삼성전자우 1Q 실적 (우선주)' },
  { id:'kr51', date:'2026-05-14', title:'인텔리안테크 실적',      imp:'med',  type:'earnings', desc:'인텔리안테크 1Q 실적' },
  { id:'kr52', date:'2026-05-14', title:'툴젠 실적',              imp:'med',  type:'earnings', desc:'툴젠 1Q 실적' },
  { id:'kr53', date:'2026-05-14', title:'레인보우로보틱스 실적',  imp:'med',  type:'earnings', desc:'레인보우로보틱스 1Q 실적' },
  { id:'kr54', date:'2026-05-14', title:'클로봇 실적',            imp:'med',  type:'earnings', desc:'클로봇 1Q 실적' },
  { id:'kr55', date:'2026-05-14', title:'유진로봇 실적',          imp:'med',  type:'earnings', desc:'유진로봇 1Q 실적' },
  { id:'kr56', date:'2026-05-14', title:'이랜시스 실적',          imp:'med',  type:'earnings', desc:'이랜시스 1Q 실적' },
];
...
const ETF_DB = [
  ...
  { sym:'TLT',  name:'장기국채',  tag:'채권', color:'#b0c4cc', desc:'금리 하락 포지션',     fgRange:[0,40]  },
];
...
const PageHeader: React.FC<{icon:string;title:string;sub?:string}> = ({icon,title,sub}) => (
  <div style={{padding:'20px 16px 12px'}}>
    ...
    {sub&&<div style={{fontSize:'12px',color:'#8ea5b0',marginTop:'4px'}}>{sub}</div>}
  </div>
);
...
const SectionTitle: React.FC<{children:React.ReactNode;right?:React.ReactNode}> = ({children,right}) => (
  <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'0 16px',marginBottom:'10px',marginTop:'8px'}}>
    ...
    {right&&<div style={{fontSize:'11px',color:'#8ea5b0'}}>{right}</div>}
  </div>
);
...
const FGGauge: React.FC<{data:{value:number;label:string}|null}> = ({data}) => {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',padding:'8px 0'}}>
      ...
      <div style={{fontSize:'12px',color:'#8ea5b0',marginTop:'4px'}}>Alternative.me 공포&탐욕 지수</div>
    </div>
  );
};
      ...
      <div style={{display:'flex',gap:'0',margin:'0 16px 16px',background:'#0d1b2e',borderRadius:'12px',padding:'4px',border:'1px solid #1a3050'}}>
        {tabs.map(t=>(
          <button key={t.k} onClick={()=>setSection(t.k)} style={{
            ...
            color:section===t.k?'#40c4ff':'#8ea5b0',
          }}>{t.l}</button>
        ))}
      </div>
          ...
          {loading?<div style={{textAlign:'center',padding:'40px'}}><Spinner s={28}/></div>:
            <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
              {IDX_META.map(m=>{
                ...
                const zone=pct52==null?null:pct52<20?{t:'🟢 기회구간',c:'#00e676'}:pct52>80?{t:'🔴 고점권',c:'#ff5252'}:pct52>60?{t:'🟡 주의',c:'#ffd740'}:{t:'🔵 중간',c:'#8ea5b0'};
                return (
                  <div key={m.yf} style={{background:'#0d1b2e',borderRadius:'14px',padding:'16px',border:`1px solid ${c}22`,borderLeft:`4px solid ${c}`}}>
                    <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:'10px'}}>
                      <div>
                        <div style={{fontSize:'12px',color:'#8ea5b0',letterSpacing:'1px'}}>{m.sym}</div>
                        <div style={{fontSize:'16px',fontWeight:'700',color:'#b0c4cc'}}>{m.name}</div>
                      </div>
                      {zone&&<span style={{fontSize:'12px',color:zone.c,fontWeight:'600'}}>{zone.t}</span>}
                    </div>
                    {!q?<div style={{color:'#607d8b'}}>—</div>:<>
                      ...
                      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
                        ...
                        <span style={{fontSize:'13px',color:'#8ea5b0'}}>{q.change>=0?'+':''}{fmt(q.change)}</span>
                      </div>
                      {pct52!=null&&(
                        <div style={{marginTop:'12px'}}>
                          <div style={{display:'flex',justifyContent:'space-between',fontSize:'11px',color:'#607d8b',marginBottom:'4px'}}>
                ...
                <div key={c.id} style={{background:'#0d1b2e',borderRadius:'14px',padding:'16px',border:'1px solid #1a3050',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                  <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
                    ...
                    <div>
                      ...
                      <div style={{fontSize:'12px',color:'#607d8b',marginTop:'2px'}}>{fmtC(c.market_cap)}</div>
                    </div>
                  </div>
              ...
              {forexList.map(fx=>(
                <div key={fx.pair} style={{background:'#0d1b2e',borderRadius:'14px',padding:'16px 20px',border:'1px solid #1a3050',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                  <div>
                    ...
                    <div style={{fontSize:'12px',color:'#8ea5b0',marginTop:'3px'}}>{fx.label}</div>
                  </div>
              ...
              return (
                <div key={m.yf} style={{background:'#0d1b2e',borderRadius:'14px',padding:'16px',border:'1px solid #1a3050',display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                  <div>
                    ...
                    <div style={{fontSize:'12px',color:'#8ea5b0'}}>{m.unit}</div>
                  </div>
      ...
      <div style={{display:'flex',gap:'8px',overflowX:'auto',padding:'0 16px 12px',scrollbarWidth:'none'}}>
        {filters.map(([k,l])=>(
          <button key={k} onClick={()=>setNF(k)} style={{
            ...
            background:nf===k?'#40c4ff22':'#0d1b2e',color:nf===k?'#40c4ff':'#b0c4cc',
            cursor:'pointer',fontSize:'13px',whiteSpace:'nowrap',fontWeight:nf===k?'700':'400',
          }}>{l}</button>
        ))}
      </div>
      <div style={{padding:'0 16px'}}>
        {filtered.length===0&&<div style={{textAlign:'center',color:'#607d8b',padding:'60px',fontSize:'14px'}}>뉴스 없음</div>}
        <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
              ...
              <a key={item.id} href={item.url} target="_blank" rel="noreferrer" style={{textDecoration:'none'}}>
                <div style={{background:item.isTrump?'rgba(255,82,82,.06)':'#0d1b2e',border:`1px solid ${item.isTrump?'rgba(255,82,82,.25)':'#1a2535'}`,borderRadius:'14px',padding:'16px'}}>
                  <div style={{display:'flex',gap:'6px',alignItems:'center',marginBottom:'10px',flexWrap:'wrap'}}>
                    ...
                    <span style={{fontSize:'11px',color:'#607d8b',marginLeft:'auto'}}>{item.source} · {item.time}</span>
                  </div>
...
const InvestorTradingMobile: React.FC<{data:MarketData['investorTrading']}> = ({data}) => {
  ...
  if(!data?.data) return (
    <div style={{margin:'0 16px 14px',background:'#0d1b2e',borderRadius:'16px',padding:'20px',border:'1px solid #1a3050',textAlign:'center',color:'#607d8b',fontSize:'13px',lineHeight:'1.6'}}>
      👥 투자자별 데이터<br/>
      <span style={{fontSize:'12px'}}>GitHub Actions 다음 실행 후 표시됩니다</span>
    </div>
  );
  ...
  const fmtAmt = (n:number) => isRatioBased ? `${(n/100).toFixed(1)}%` : fmtBn(n);

  return (
    <div style={{marginBottom:'14px'}}>
      <SectionTitle>👥 투자자별 TOP 10</SectionTitle>
      <div style={{padding:'0 16px'}}>
        {/* 날짜 */}
        {dateLabel&&<div style={{fontSize:'11px',color:'#607d8b',marginBottom:'10px'}}>{dateLabel}{isRatioBased?' · 외국인지분율':' · 거래대금'}</div>}
        ...
        <div style={{display:'flex',gap:'6px',marginBottom:'12px'}}>
          {(['buy','sell'] as const).map(s=>(
            <button key={s} onClick={()=>setSide(s)} style={{
              ...
              color: side===s ? (s==='buy'?'#00e676':'#ff5252') : '#607d8b',
        ...
        <div style={{background:'#0d1b2e',borderRadius:'16px',padding:'14px 16px',border:'1px solid #1a3050'}}>
          {list.length===0
            ? <div style={{color:'#607d8b',fontSize:'13px',textAlign:'center',padding:'16px'}}>데이터 없음</div>
            : list.slice(0,10).map((item,i)=>(
              <div key={item.code} style={{marginBottom: i<list.length-1?'12px':'0'}}>
                <div style={{display:'flex',alignItems:'center',gap:'8px',marginBottom:'4px'}}>
                  <span style={{fontSize:'12px',color:'#8ea5b0',width:'18px',textAlign:'right',fontWeight:'700',flexShrink:0}}>{i+1}</span>
                  ...
                  <span style={{fontSize:'14px',fontWeight:'700',color: side==='buy'?'#00e676':'#ff5252',flexShrink:0}}>{fmtAmt(item.amount)}</span>
                </div>
...
const AnalysisPage: React.FC<{quotes:Record<string,Quote>;fg:{value:number;label:string}|null;loading:boolean;investorTrading?:MarketData['investorTrading']}> = ({quotes,fg,loading,investorTrading}) => {
  ...
  else{phase='중립 — 선별적 접근';phaseColor='#b0c4cc';phaseDesc='방향성 불명확. 섹터 로테이션 주시';strategy='분산 유지, 한 섹터 집중 지양';}
  ...
  return (
    <div>
      ...
      <div style={{margin:'0 16px 14px',background:'#0d1b2e',borderRadius:'16px',padding:'20px',border:`1px solid ${phaseColor}33`}}>
        <div style={{fontSize:'13px',color:'#8ea5b0',marginBottom:'8px'}}>현재 시장 국면</div>
        <div style={{fontSize:'18px',fontWeight:'700',color:phaseColor,marginBottom:'8px'}}>{phase}</div>
        <div style={{fontSize:'14px',color:'#b0c4cc',lineHeight:'1.6',marginBottom:'14px'}}>{phaseDesc}</div>
        ...
        <div style={{display:'flex',gap:'24px'}}>
          <div style={{textAlign:'center'}}>
            ...
            <div style={{fontSize:'12px',color:'#8ea5b0',marginTop:'2px'}}>공포&탐욕</div>
          </div>
          <div style={{textAlign:'center'}}>
            <div style={{fontSize:'32px',fontWeight:'700',color:avgPos<30?'#00e676':avgPos>70?'#ff5252':'#40c4ff'}}>{avgPos.toFixed(0)}%</div>
            <div style={{fontSize:'12px',color:'#8ea5b0',marginTop:'2px'}}>52주 평균</div>
          </div>
        </div>
      </div>
      ...
      <div style={{margin:'0 16px 14px',background:'#0d1b2e',borderRadius:'16px',padding:'16px',border:'1px solid #1a3050'}}>
        {sectorPerf.length===0?<div style={{color:'#607d8b',fontSize:'13px',padding:'10px'}}>로딩 중...</div>:
          sectorPerf.map((s,i)=>(
            <div key={s.yf} style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:i<sectorPerf.length-1?'14px':'0'}}>
              <div style={{fontSize:'13px',color:'#8ea5b0',width:'18px',textAlign:'right',flexShrink:0,fontWeight:'700'}}>{i+1}</div>
              ...
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'12px'}}>
                <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
                  ...
                  <div>
                    ...
                    <div style={{fontSize:'12px',color:'#607d8b'}}>{def.yf} ETF</div>
                  </div>
                </div>
              ...
              {def.stocks.map((sym,i)=>{
                ...
                return (
                  <div key={sym} style={{display:'flex',alignItems:'center',gap:'10px',padding:'10px 0',borderTop:'1px solid #1a2535'}}>
                    <span style={{fontSize:'12px',color:'#8ea5b0',width:'52px',flexShrink:0,fontWeight:'600'}}>{sym.replace('.KS','')}</span>
    ...
    <div>
      ...
      <div style={{display:'flex',gap:'8px',overflowX:'auto',padding:'0 16px 14px',scrollbarWidth:'none'}}>
        {typeFilters.map(({k,l})=>(
          <button key={k} onClick={()=>setTypeFilter(k)} style={{
            ...
            color:typeFilter===k?(EVT_COLOR[k]??'#40c4ff'):'#b0c4cc',
      ...
      <div style={{margin:'0 16px 16px',background:'#0d1b2e',borderRadius:'16px',padding:'16px',border:'1px solid #1a3050'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'6px',marginBottom:'14px'}}>
          <button onClick={prev} style={{background:'#1a2535',border:'none',color:'#b0c4cc',cursor:'pointer',width:'36px',height:'36px',borderRadius:'50%',fontSize:'20px',display:'flex',alignItems:'center',justifyContent:'center'}}>‹</button>
          <span style={{fontSize:'18px',fontWeight:'700',color:'#eceff1',padding:'0 4px'}}>{yr}년 {MONTHS_KO[mo]}</span>
          <button onClick={next} style={{background:'#1a2535',border:'none',color:'#b0c4cc',cursor:'pointer',width:'36px',height:'36px',borderRadius:'50%',fontSize:'20px',display:'flex',alignItems:'center',justifyContent:'center'}}>›</button>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(7,1fr)',marginBottom:'6px'}}>
          {DAYS_KO.map((d,i)=>(
            <div key={d} style={{textAlign:'center',fontSize:'12px',fontWeight:'700',padding:'4px 0',color:i===0?'#ff5252':i===6?'#5c9eff':'#8ea5b0'}}>{d}</div>
          ))}
        </div>
        {/* 날짜 그리드 (크게) */}
        ...
        <div style={{display:'flex',gap:'10px',marginTop:'14px',flexWrap:'wrap'}}>
          {Object.entries(EVT_COLOR).map(([k,c])=>(
            <span key={k} style={{fontSize:'11px',color:'#8ea5b0'}}><span style={{color:c}}>■</span> {EVT_LABEL[k]}</span>
          ))}
        </div>
      </div>
        ...
        <div style={{margin:'0 16px 16px',background:'#060d1a',borderRadius:'14px',padding:'18px',border:`1px solid ${EVT_COLOR[sel.type]??'#1a2535'}66`}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'10px'}}>
            <div style={{display:'flex',gap:'8px',alignItems:'center'}}>
              <span style={{fontSize:'12px',padding:'4px 10px',borderRadius:'8px',background:(EVT_COLOR[sel.type]??'#8ea5b0')+'22',color:EVT_COLOR[sel.type]??'#8ea5b0',border:`1px solid ${EVT_COLOR[sel.type]??'#8ea5b0'}44`,fontWeight:'600'}}>{EVT_LABEL[sel.type]??sel.type}</span>
              <span style={{fontSize:'12px',color:'#8ea5b0'}}>{sel.date}</span>
            </div>
            <button onClick={()=>setSel(null)} style={{background:'none',border:'none',color:'#8ea5b0',cursor:'pointer',fontSize:'22px',padding:'0 4px'}}>×</button>
          </div>
          <div style={{fontSize:'17px',color:'#eceff1',fontWeight:'700',marginBottom:'6px'}}>{sel.title}</div>
          <div style={{fontSize:'14px',color:'#b0c4cc',lineHeight:'1.5'}}>{sel.desc}</div>
            ...
            <div key={ev.id} style={{background:'#0d1b2e',borderRadius:'14px',padding:'16px',marginBottom:'10px',border:`1px solid ${ec}22`,display:'flex',gap:'14px',alignItems:'flex-start'}}
              ...
              <div style={{flex:1}}>
                <div style={{display:'flex',gap:'8px',alignItems:'center',marginBottom:'6px',flexWrap:'wrap'}}>
                  ...
                  <span style={{fontSize:'12px',color:diffDays<=3?'#ffd740':'#8ea5b0',fontWeight:'600'}}>{dTag}</span>
                ...
                <div style={{fontSize:'13px',color:'#8ea5b0'}}>{ev.desc}</div>
              </div>
            </div>
          );
        })}
        <div style={{fontSize:'12px',color:'#607d8b',textAlign:'center',padding:'8px 0 16px'}}>
      ...
      <div style={{display:'flex',gap:'8px',overflowX:'auto',padding:'0 16px 14px',scrollbarWidth:'none'}}>
        {CHARTS.map(([s,n])=>(
          <button key={s} onClick={()=>setCS(s)} style={{
            ...
            color:chartSym===s?'#40c4ff':'#b0c4cc',
          ...
          {IDX_META.map((m,i)=>{
            ...
            return (
              <div key={m.yf} style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'13px 16px',borderBottom:i<IDX_META.length-1?'1px solid #1a2535':'none'}}>
                <div>
                  <span style={{fontSize:'13px',color:'#8ea5b0',marginRight:'8px'}}>{m.sym}</span>
                  <span style={{fontSize:'14px',color:'#b0c4cc'}}>{m.name}</span>
                </div>
                {!q?<Spinner/>:<div style={{textAlign:'right'}}>
    ...
    <div style={{background:'#060d1a',color:'#e0e6ed',fontFamily:"'Inter','Noto Sans KR',system-ui,sans-serif",minHeight:'100vh',maxWidth:'480px',margin:'0 auto',position:'relative',display:'flex',flexDirection:'column'}}>
      ...
      <div style={{background:'linear-gradient(135deg,#07122a,#0d1f3f)',borderBottom:'1px solid #00d4ff22',padding:'12px 16px',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
        <div>
          ...
          <div style={{fontSize:'11px',color:'#607d8b',marginTop:'2px'}}>
        ...
        <div style={{textAlign:'right'}}>
          ...
          <div style={{fontSize:'10px',color:'#607d8b'}}>{nowT.toLocaleDateString('ko-KR')}</div>
        </div>
      </div>
      ...
      <div ref={scrollRef} style={{flex:1,overflowY:'auto',paddingBottom:'72px'}}>
        {loading
          ? <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'60vh',gap:'16px'}}>
              <Spinner s={36}/>
              <div style={{color:'#8ea5b0',fontSize:'15px'}}>시장 데이터 로딩 중...</div>
              <div style={{color:'#607d8b',fontSize:'12px',textAlign:'center',lineHeight:'1.6',padding:'0 32px'}}>GitHub Actions가 10분마다 최신 데이터를 수집합니다.<br/>첫 실행 후 자동으로 표시됩니다.</div>
            </div>
          : <>
